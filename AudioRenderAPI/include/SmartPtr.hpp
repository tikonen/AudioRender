...
public:
    ...
    template <class U>
    class _NoAddRefOrRelease : public U
    {
    private:
    ...
    _NoAddRefOrRelease<T>* operator->() const { return (_NoAddRefOrRelease<T>*)m_ptr; }
...
template <class T>
class SmartPtrArray : public std::vector<SmartPtr<T>>
{
public:
